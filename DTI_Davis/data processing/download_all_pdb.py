...
protein_id = np.loadtxt("E:/OneDrive/桌面/CMMSCL_DPI/github local/DTI_Davis/processing dataset/protein_id.txt", dtype=str)
uniport_id2pdb_id = pd.read_csv("E:/OneDrive/桌面/CMMSCL_DPI/github local/DTI_Davis/processing dataset/non390_pidmapping.tsv", sep="\t", header=0)
...
def download_af_pdb(p_id_without_pdb):
    for p_name in tqdm(p_id_without_pdb):
        ...
        save_path = "E:/OneDrive/桌面/CMMSCL_DPI/github local/DTI_Davis/processing dataset/non390pdb_file/AF-" + p_name + "-F1-model_v4.pdb"
...
def download_pdb(uniport_id2pdb_id):
    for i in tqdm(uniport_id2pdb_id.To):
        ...
        save_path = "E:/OneDrive/桌面/CMMSCL_DPI/github local/DTI_Davis/processing dataset/non390pdb_file/" + i + ".pdb"
        if not os.path.exists(save_path):
...
def get_redownload_pdb_id(uniport_id2pdb_id):
    ...
    for line_i in tqdm(range(len(uniport_id2pdb_id))):
        ...
        save_path = "E:/OneDrive/桌面/CMMSCL_DPI/github local/DTI_Davis/processing dataset/non390pdb_file/" + pdb_id + ".pdb"
        if not os.path.exists(save_path):
...
def get_best_pdb(downloaded_uniport_id2pdb_id,p_id_without_pdb,p_id_with_pdb):
    ...
    for p_name in tqdm(p_id_with_pdb):
        ...
        for pdb_name in pdb_names:
            pdb_path = "E:/OneDrive/桌面/CMMSCL_DPI/github local/DTI_Davis/processing dataset/non390pdb_file/" + pdb_name + ".pdb"
        ...
        best_pdb_path = "E:/OneDrive/桌面/CMMSCL_DPI/github local/DTI_Davis/processing dataset/non390pdb_file/" + best_pdb_name[0] + ".pdb"
        best_pdb_save_path = "E:/OneDrive/桌面/CMMSCL_DPI/github local/DTI_Davis/processing dataset/non390best_pdb_file/" + p_name + ".pdb"
    ...
    for p_name in tqdm(p_id_without_pdb):
        pdb_path = "E:/OneDrive/桌面/CMMSCL_DPI/github local/DTI_Davis/processing dataset/non390pdb_file/AF-" + p_name + "-F1-model_v4.pdb"
        best_pdb_save_path = "E:/OneDrive/桌面/CMMSCL_DPI/github local/DTI_Davis/processing dataset/non390best_pdb_file/" + p_name + ".pdb"
