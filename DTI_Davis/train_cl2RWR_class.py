...
if __name__ == '__main__':
    ...
    parser.add_argument('--gt_heads', type=int, default=9, help='gt_heads')
    parser.add_argument('--gt_layers', type=int, default=9, help='gt_layers')
    ...
    parser.add_argument('--dataset_path', default='/home/zqguxingyue/DTI_Davis/PPI/Davis_classification.csv', help='dataset path')
